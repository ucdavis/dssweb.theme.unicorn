FacetedEdit.DSSDatepickerWidget = function(wid){
  this.wid = wid;
...
FacetedEdit.DSSDatepickerWidget.prototype = {
...
FacetedEdit.initializeDSSDatepickerWidget= function(){
  jQuery('div.faceted-text-widget').each(function(){
      var wid = jQuery(this).attr('id');
      wid = wid.split('_')[0];
      FacetedEdit.Widgets[wid] = new FacetedEdit.DSSDatepickerWidget(wid);
  });
};
...
jQuery(document).ready(function(){
  jQuery(FacetedEdit.Events).bind(
    ...
    FacetedEdit.initializeDSSDatepickerWidget);
});
